...
const PaymentPage = () => {
    ...
    const getCurrentHotel = async () => {
        try {
            ...
            setCreditCardOption(data.credit_card_options ? 'yes' : 'no')
    ...
    return (
        <Content>
            <RouteNavigationBar previous={"Policies"} current={"Payment"} handleEditToggle={handleEditToggle} editMode={editMode} handlePrevious={handlePrevious} handleSave={handleSave}/>
            ...
            >
                ...
                <div className="bg-gray-100 rounded-md w-full flex flex-col gap-6 py-8 px-6 font-montserrat">
                    ...
                    <div className="grid md:grid-cols-2">
                        ...
                        <p className="text-md text-gray-600 font-semibold flex justify-end">
